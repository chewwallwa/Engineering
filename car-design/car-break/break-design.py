...
W   = 4000 # [N] peso do carro
l_m = 1340 # [mm] roda F ate o CG
L   = 2300 # [mm] roda F ate R
h_m = 296 # [mm] chão ao CG

mi  = 1.7 # [~] roda/chão coeficiente de atrito
mi_b= 0.5 # [~] pad/disco ==
r_r = 270 # [mm] raio de rolagem da roda
r_b = 100 # [mm] centro do disco ao centro dos pads

A_sf  = 1587 # [mm2] area do pistao do calliper F
A_sr  = 1019 # [mm2] area do pistao do calliper L
B1nB2 = 65 # [mm] distancia entre os master cylinder
...
for D_mf in st_D_m:
    for D_mr in st_D_m:
        ...
        A_mf = pi * ((D_mf/2) * 25.4)**2
        A_mr = pi * ((D_mr/2) * 25.4)**2
